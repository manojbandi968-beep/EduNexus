...
// ============================================
// CollegeDost — Teacher Login Page
// ============================================
...
import { BookOpen, Eye, EyeOff, Lock, Mail, ArrowLeft, Sun, Moon, Smartphone } from 'lucide-react';
    ...
    <div className="auth-bg pattern-dots relative flex min-h-screen items-center justify-center px-4 py-12">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute -right-20 top-1/3 h-72 w-72 rounded-full bg-indigo-500/10 blur-3xl"
        />
        <motion.div
      ...
      >
        <Card className="glass-card border-0 shadow-2xl">
          <CardHeader className="text-center">
            {/* Icon */}
            <motion.div
              className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 to-indigo-600 shadow-lg shadow-indigo-500/25"
            ...
            <CardDescription className="text-muted-foreground">
              Manage your attendance, quizzes, and student progress
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleEmailLogin} className="space-y-5">
              ...
              <Button
                ...
                className="h-12 w-full rounded-xl bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 border-0 text-white shadow-lg shadow-indigo-500/20 transition-all hover:shadow-xl"
              >
                {loading ? (
